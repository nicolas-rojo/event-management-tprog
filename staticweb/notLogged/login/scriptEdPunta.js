	...
	form.addEventListener("submit", (e) => {
		...
		if (user) {
			...
			if (user.nickname == "atorres") {
				window.location.href = "../../loggedAsist/consultaEdicion/consultaEdicionTecPunta.html";
			} else {
				window.location.href = "../../loggedOrg/consultaEdicion/consultaEdicionTecPunta.html";
			}
		} else {
