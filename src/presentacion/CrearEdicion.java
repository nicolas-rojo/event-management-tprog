...
public class CrearEdicion extends JInternalFrame {
	...
	protected void altaDeEdicion(ActionEvent aceptar) {
        ...
        if (checkFormulario()) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Edicion registrada correctamente",
                        "Alta de Ediciion", JOptionPane.INFORMATION_MESSAGE);
                limpiarFormulario();
                setVisible(false);
            } catch (EdicionRepetidaExcepcion e) {
                JOptionPane.showMessageDialog(this, e.getMessage(),
                        "Error al registrar edicion", JOptionPane.ERROR_MESSAGE);
            } 
        }
    }
	...
	private boolean checkFormulario() {
	     ...
	     else if(fechaIni.isAfter(fechaFin) || !fechaIni.isAfter(fechaAlta)) {
	...
	public void cargarEventos() {
		...
		if (eventos != null) {
			for (String evt : eventos) {
				
				comboBoxEventos.addItem(evt);
			}
        }
	}
