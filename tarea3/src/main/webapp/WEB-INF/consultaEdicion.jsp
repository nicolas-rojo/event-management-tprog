	...
	<div class="info-container">
		<a href="" class="event-card">
			...
			<div class="event-card-content">
				...
				<p class="event-card-description">Desde: <%=dataEd.getFechaIni()%> - Hasta: <%=dataEd.getFechaFin()%></p>
				<p class="event-card-description">Alta: <%=dataEd.getFechaAlta()%></p>
		...
		%>
			...
			<div class="mi-registro-card">
				<div class="registro-dato">
					<span class="registro-label">Fecha de registro:</span> 
					<span class="registro-valor"><%= detalleReg.getFecha() %></span>
				</div>
				<div class="registro-dato">
					<span class="registro-label">Tipo de registro:</span> 
					<span class="registro-valor"><%= detalleReg.getNombreTR() %></span>
				</div>
			</div>
			<% 
			} 
						...
						<div class="patrocinio-card">
							<div class="patrocinio-header">
								...
								<div class="patrocinio-badges">
									<span class="patrocinio-tipo"><%=dataP.getTipoRegistro()%></span> 
									<span class="patrocinio-nivel nivel-<%= dataP.getNivel().toString().toLowerCase()%>"><%=dataP.getNivel()%></span>
								</div>
							</div>
