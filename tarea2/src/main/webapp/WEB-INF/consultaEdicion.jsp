				...
				<div class="informacion-TRegistro">
					<div class="detalles-TRegistro">
						...
						<div class="registro-item">
							...
							<button  id="descargar" class="Btn" onclick="window.open('<%= request.getContextPath() %>/ComprobantePDF?edicion=<%= dataEd.getNombre() %>&ciudad=<%= dataEd.getCiudad() %>&fecha=<%= detalleReg.getFecha() %>&evento=<%= request.getParameter("evento") %>', '_blank')">
