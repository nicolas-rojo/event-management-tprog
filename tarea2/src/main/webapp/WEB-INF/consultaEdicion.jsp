...
<body>
	...
	<div class="content">
				...
				<div class="informacion-evento">
					...
					<div class="detalles-evento">
						<span class="pais"><%= dataEd.getPais() %></span> <span
							class="fechas">Desde: <%= dataEd.getFechaIni() %> - Hasta:
							<%= dataEd.getFechaFin() %></span> <span class="fecha-alta">Alta:
							<%= dataEd.getFechaAlta() %></span> <span class="siglas">SIG: <%= dataEd.getSigla() %></span>
					</div>
				</div>
			</div>
		...
		<div class="columna-derecha">
			...
			<a
				href='${pageContext.request.contextPath}/detalleUsuario?email=<%= java.net.URLEncoder.encode(dataOrg.getEmail(), "UTF-8") %>'">
