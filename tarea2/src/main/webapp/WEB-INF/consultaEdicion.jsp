...
<body>
	...
	<div class="content">
			...
			<div class="contenedor-principal">
				...
				<div class="informacion-evento">
					...
					<div class="detalles-evento">
						<span class="pais"><%= dataEd.getPais() %></span> <span
							class="fechas"> Desde: <%= dataEd.getFechaIni() %> -
							Hasta: <%= dataEd.getFechaFin() %>
						</span> <span class="fecha-alta"> Alta: <%= dataEd.getFechaAlta() %>
						</span> <span class="siglas"> SIG: <%= dataEd.getSigla() %>
						</span>
					</div>
				</div>
			</div>
				...
				<div class="contenedor">
					<div class="informacion-TRegistro">
						...
						<div class="detalles-TRegistro">
							...
							<span class="costo-TRegistro">Costo: $<%= dataTR.getCosto() %>.
							</span> <span class="Cupos-TRegistro"><%= dataTR.getCupo() %>
								cupos restantes.</span>
						</div>
					</div>
				</div>
				<%
			...
			<div class="contenedorTRegistros">
				...
				<div class="contenedor">
					...
					<div class="informacion-edicion">
						<h2 class="nombre-evento"><%= dataP.getInstitucion() %>>
						</h2>
						<div class="detalles-edicion">
							<span class="fecha-patrocinio">Fecha: <%= dataP.getFecha() %></span>
							<span class="aporte-patrocinio">Aporte: $<%= dataP.getMonto() %>.
							</span> <span class="nivel-patrocinio">Nivel: <%= dataP.getNivel() %>.
							</span> <span class="tipo-patrocinio">Código: <%= dataP.getCod() %>.
							</span> <span class="Cupos-patrocinio">Cupos: <%= dataP.getCtdCupo() %>.
							</span>
						</div>
					</div>
				</div>
		...
		<div class="columna-derecha">
			...
			<a href="../consultaUsuario/consultaDetalleOrganizador.html"
			...
			<h2 class="texto-registro" id="registro-titulo"
				style="display: block;">Registro:</h2>

			<div class="contenedor-derecha-alt" id="registro-detalle"
				style="display: flex;">
				<div class="informacion-TRegistro">
					<div class="detalles-TRegistro">
						<div class="registro-item">
							<%= request.getAttribute("nickmail") %>
						</div>
						<div class="registro-item">
							<%= request.getAttribute("tipoRegistro") != null ? request.getAttribute("tipoRegistro") : "NO" %>
						</div>
					</div>
				</div>
			</div>

			<h2 class="texto-registro" id="listado-titulo" style="display: none;">Listado
				de registros:</h2>
			...
			<div class="contenedor-derecha-alt" id="listado-registros"
				...
				<div class="informacion-TRegistro">
					<div class="detalles-TRegistro">
						<div class="registro-item">Sin registros actualmente.</div>
					</div>
				</div>
			</div>
		</div>
