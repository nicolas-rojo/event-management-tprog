...
<!-- CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/styles/listarUsuariosStyle.css">
</head>
...
<%
    ...
    // DECLARAR E INICIALIZAR ICU_WS AQUÍ
    ...
    if (usuarios != null && usuarios.length > 0 && ICU_WS != null) {
%>
<div class="contenedor-usuarios">
    ...
    for (DataUsuario usuario : usuarios) {
        ...
        try {
            ...
            System.err.println("⚠️ Error obteniendo detalles adicionales para el usuario " + usuario.getEmail() + " ("
