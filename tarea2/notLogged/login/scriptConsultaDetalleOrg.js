	...
	form.addEventListener("submit", (e) => {
		...
		if (user) {
			...
			if (user.nickname == "atorres") {
				window.location.href = "../../loggedAsist/consultaUsuario/consultaDetalleOrganizador.html";
			} else {
				window.location.href = "../../loggedOrg/consultaUsuario/consultaDetalleOrganizador.html";
			}
		} else {
