	...
	form.addEventListener("submit", (e) => {
		...
		if (user) {
			...
			if (user.nickname == "atorres") {
				window.location.href = "../../loggedAsist/consultaEdicion/consultaEdicionMaraton22.html";
			} else {
				window.location.href = "../../loggedOrg/consultaEdicion/consultaEdicionMaraton22.html";
			}
		} else {
