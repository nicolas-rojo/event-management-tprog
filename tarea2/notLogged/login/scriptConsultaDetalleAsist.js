	...
	form.addEventListener("submit", (e) => {
		...
		if (user) {
			...
			if (user.nickname == "atorres") {
				window.location.href = "../../loggedAsist/consultaUsuario/consultaDetalleAsistente.html";
			} else {
				window.location.href = "../../loggedOrg/consultaUsuario/consultaDetalleAsistente.html";
			}
		} else {
